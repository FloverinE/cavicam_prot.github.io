...
# # Install the Matrix package from the Posit Package Manager
# install.packages("https://packagemanager.posit.co/cran/latest/src/contrib/Archive/car/car_3.1-2.tar.gz", repos = NULL, type = "source")
# install.packages("https://packagemanager.posit.co/cran/latest/src/contrib/Archive/Matrix/Matrix_1.5-1.tar.gz", repos = NULL, type = "source")
# install.packages("https://packagemanager.posit.co/cran/latest/src/contrib/fitplc_1.2-3.tar.gz", repos = NULL, type = "source")
# install.packages("fitplc", dependencies = FALSE)
